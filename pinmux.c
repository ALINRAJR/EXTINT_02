...
void vPinmuxInitialize(void)
{
	...
	/* Selecting External interrupt functionality for the selected pins */
	...
	vPinmuxSel(ExtIntPins[2].GPIOx,ExtIntPins[2].pin,ExtIntPins[2].func);
	vPinmuxSel(ExtIntPins[3].GPIOx,ExtIntPins[3].pin,ExtIntPins[3].func);
